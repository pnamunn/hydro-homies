...
static const char *STA = "station wifi";
static const char *NTP = "network time protocol";
static int retry_count = 0;

// const char* NTPServer = "pool.ntp.org";
// const long gmtOffset_sec = -7 * 60 * 60;   // PST timezone
// const int daylightOffset_sec = 1 * 60 * 60;    // is daylight savings
...
void app_main(void)
{
    ...
    while(1) {
        ...
        printf("Current time is:  %s", asctime(localtime(&current_time)));        
    }
}
